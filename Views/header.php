    ...
    <nav class="navbar justify-content-center" id="nav">
        <div class="navbar navbar-sm-collapse text-monospace" id="fixnav">
            <div class="navbar-nav d-flex flex-row" id="links">
                <a class="nav-item nav-link py-4 px-3 text-info" id="navbar-link" href="#about">About us</a>
                <a class="nav-item nav-link py-4 px-3 text-info" id="navbar-link" href="listtickets.php">Our Work</a>
                <a class="navbar-brand mx-4 py-0 text-center" href="../Views/listtickets.php">
                    <img src="../images/picture.png" class="rounded-circle w-50" alt="logo">
                </a>
                <a class="nav-item nav-link py-4 px-2 text-info" id="navbar-link" href="#">Contact</a>
                <?php if(isset($_SESSION['id'])){?>
                    <a class="nav-item nav-link py-4 px-3vtext-info" id="navbar-link" href="login.php">Logout</a>
                <?php }
                else{ ?>
