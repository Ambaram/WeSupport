...
?>
      <main role="main" class="inner cover mb-5 text-light" id="cover">
      ...
      <section class="container-fluid row justify-content-center" id="about">
          ...
          <div class="col-sm-3 text-center m-3 p-2" id="what">
              <div>
              ...
              <p class="btn border border-success text-monospace text-success">About Us</p>
          </div>
          <div class="col-sm-3 text-center m-3 p-2" id="how">
              ...
              <p class="btn border border-info text-monospace text-info">Our Team</p>
          </div>
          <div class="col-sm-3 text-center m-3 p-3" id="connect">
              ...
              <p class="btn border border-success text-monospace text-success">Raise new Ticket</p>
          </div>
</div>
      </section>
